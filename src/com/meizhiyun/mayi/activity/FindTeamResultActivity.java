...
public class FindTeamResultActivity extends BaseActivity {
	...
	private void init() {
				...
				if (actionId == EditorInfo.IME_ACTION_SEARCH) {
					...
					if (!TextUtils.isEmpty(nickname)) {
						...
						BaseApplication.toastMethod(
								FindTeamResultActivity.this, "昵称不能为空", 1);
					}
					return true;
				}
				return false;
		...
		adapter = new FindTeamAdapter(FindTeamResultActivity.this, userid);
		...
		httpUtils.send(HttpMethod.POST, UrlConfig.BASICURL, params,
				new RequestCallBack<String>() {
					...
					public void onFailure(HttpException error, String msg) {
						...
						llLoading.setVisibility(View.GONE);
						BaseApplication.toastMethod(
								FindTeamResultActivity.this, msg, 0);
					}
				});
			...
			public void run() {
				...
				while (flag) {
					...
					hasNet = BaseApplication
							.judgeNetwork(FindTeamResultActivity.this);
